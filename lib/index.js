...
(function (base) {
    var CustomApi = (function () {
        ...
        CustomApi.prototype.onEvent = function (cbk) {
            this.error_cbk = cbk;
            return this;
        };
        CustomApi.prototype.onError = function (cbk) {
            this.error_cbk = cbk;
            return this;
        };
        CustomApi.prototype.onAccountChanged = function (cbk) {
            this.account_changed_cbk = cbk;
            return this;
        };
        CustomApi.prototype.onIdentity = function (cbk) {
            this.identity_cbk = cbk;
            return this;
        };
        CustomApi.prototype.onContract = function (cbk) {
    ...
    var EthApi = (function (_super) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            e_1 = _a.sent();
                            this.error_cbk && this.error_cbk(base.ErrorCode.MissIdentity, e_1);
                            return [3, 4];
                        case 4: return [2];
                    }
                });
        ...
        EthApi.prototype.updateStatus = function () {
            ...
            web3.version.getNetwork(function (err, netId) {
                ...
                err && _this.error_cbk && _this.error_cbk(base.ErrorCode.NetError, err);
            });
            web3.eth.getAccounts(function (err, res) {
                ...
                err && _this.error_cbk && _this.error_cbk(base.ErrorCode.AccountError, err);
            });
        };
    ...
    var EosApi = (function (_super) {
        ...
        function EosApi(config, mode) {
            ...
            if (_this._scatter) {
                ...
                _this._eos = _this._scatter.eos(_this._config.eosNetwork, win['Eos'], {}, _this._config.protocal);
            }
            else {
        ...
        EosApi.prototype.updateStatus = function () {
            ...
            if (this.identity) {
                ...
                if (name_1 !== this.defaultAccount()) {
                    this.account_changed_cbk && this.account_changed_cbk(this.defaultAccount(), name_1);
                }
            }
        };
