...
var EthApi = /** @class */ (function (_super) {
    ...
    function EthApi(config, mode) {
        ...
        for (var _i = 0, contracts_1 = contracts; _i < contracts_1.length; _i++) {
            ...
            _this._web3_browser && (_this._contractMap[contract.name] = _this._web3_browser.eth.contract(contract.data).at(contract.address));
        }
        return _this;
    }
    ...
    EthApi.prototype.plugin = function () { return "MateMask"; }; // 插件名称
    EthApi.prototype.usePlugin = function () { return true; }; // 是否使用插件
    EthApi.prototype.isInitPlugin = function () { return this._web3 != undefined; }; // 插件是否初始化了
    EthApi.prototype.hasAccount = function () { return this._account != undefined; }; // 是否有账号
    EthApi.prototype.defaultAccount = function () { return this._web3 ? this._web3.eth.defaultAccount : ''; }; // 获取默认账号
